...
export declare class MenuSurfaceComponentDev extends Component {
     ...
     * ### DO NOT USE!
     */
    $$prop_def: Omit<Partial<svelte.JSX.HTMLAttributes<HTMLDivElement>>, 'use' | 'class' | 'style' | 'static' | 'anchor' | 'fixed' | 'open' | 'fullWidth' | 'quickOpen' | 'anchorElement' | 'anchorCorner' | 'anchorMargin' | 'maxHeight' | 'horizontallyCenteredOnViewport'> & Component['$$prop_def'];
}

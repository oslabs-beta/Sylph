...
export declare class IconButtonComponentDev<C extends SvelteComponentDev = ButtonElementComponentDev> extends Component {
     ...
     * ### DO NOT USE!
     */
    $$prop_def: Omit<Partial<svelte.JSX.HTMLAttributes<ReturnType<C['getElement']>>>, 'use' | 'class' | 'style' | 'ripple' | 'color' | 'toggle' | 'pressed' | 'ariaLabelOn' | 'ariaLabelOff' | 'href' | 'action' | 'component'> & Component['$$prop_def'];
}

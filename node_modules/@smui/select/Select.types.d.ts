...
export declare class SelectComponentDev extends Component {
     ...
     * ### DO NOT USE!
     */
    $$prop_def: Omit<Partial<svelte.JSX.HTMLAttributes<HTMLDivElement>>, 'use' | 'class' | 'style' | 'ripple' | 'disabled' | 'variant' | 'noLabel' | 'label' | 'value' | 'key' | 'dirty' | 'invalid' | 'updateInvalid' | 'required' | 'inputId' | 'hiddenInput' | 'withLeadingIcon'> & {
        ...
        [k in keyof Partial<svelte.JSX.HTMLAttributes<HTMLDivElement>> as `anchor\$${k}`]?: Partial<svelte.JSX.HTMLAttributes<HTMLDivElement>>[k];
    } & {
        ...
        [k in keyof Partial<svelte.JSX.HTMLAttributes<HTMLSpanElement>> as `selectedTextContainer\$${k}`]?: Partial<svelte.JSX.HTMLAttributes<HTMLSpanElement>>[k];
    } & {
        [k in keyof Partial<svelte.JSX.HTMLAttributes<HTMLSpanElement>> as `selectedText\$${k}`]?: Partial<svelte.JSX.HTMLAttributes<HTMLSpanElement>>[k];
    } & {
        [k in keyof Partial<svelte.JSX.HTMLAttributes<HTMLSpanElement>> as `dropdownIcon\$${k}`]?: Partial<svelte.JSX.HTMLAttributes<HTMLSpanElement>>[k];
    } & {
